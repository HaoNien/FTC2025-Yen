...
public abstract class basic extends OpMode {
    ...
    public void init() {
        ...
        ArmUp = hardwareMap.get(DcMotorEx.class, "armL");
        ArmDown = hardwareMap.get(DcMotorEx.class, "armR");
...
//        armEnc.setDirection(Encoder.REVERSE);
    ...
    public void armTurn2angle(double target) {
        armPosNow = ArmDown.getCurrentPosition() / armEnc2deg + armOffset; // 計算當前角度 ///*******
